...
if __name__ == "__main__":
    ...
    with open(filename, 'w') as f:
        ...
        for i in range(99):
            for j in range(10):
                e, command = print_move((70 + j * 10, 70, h), (70 + j * 10, 80, h), old_e=e)
                f.write(command + "\n")
                ...
                f.write(command + "\n")
                e, command = print_move((70 + j * 10, 90, h), (70 + j * 10, 100, h), old_e=e)
                f.write(command + "\n")
                e, command = print_move((70 + j * 10, 100, h), (75 + j * 10, 100, h), old_e=e)
                f.write(command + "\n")
                e, command = print_move((75 + j * 10, 100, h), (75 + j * 10, 90, h), old_e=e)
                f.write(command + "\n")
                ...
                f.write(command + "\n")
                e, command = print_move((75 + j * 10, 80, h), (75 + j * 10, 70, h), old_e=e)
                f.write(command + "\n")
                e, command = print_move((75 + j * 10, 70, h), (80 + j * 10, 70, h), old_e=e)
                f.write(command + "\n")
            e, command = print_move((80 + 90, 70, h), (80 + 90, 69.4, h), old_e=e)
            f.write(command + "\n")
            e, command = print_move((80 + 90, 69.4, h), (70, 69.4, h), old_e=e)
            f.write(command + "\n")
            e, command = print_move((70, 69.4, h), (70, 70, h + 0.2), old_e=e)
            f.write(command + "\n")
            h += 0.2
            if i == 0:
                f.write(fan_on() + "\n")
